...
function Sidebar() {
    ...
    return (
      <div className='hidden z-20 px-[1.5vw] py-[1vw] fixed top-0 left-0 h-screen bg-white border-r w-[16.87vw] md:block'>
        <Link to='/' reloadDocument className='flex space-x-[0.4vw]'><img src="Lumiqicon.png" className='w-[2vw]  mt-[0.25vw] mr-[0.625vw]' alt="" /><h1 className='text-[#8884d8] font-bold mt-[4px] text-[1.3vw]'>Hackstreet Boys</h1></Link>
